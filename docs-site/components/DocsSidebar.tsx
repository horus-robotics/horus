...
const sections: SidebarSection[] = [
  {
    ...
    links: [
      ...
      { title: "Roadmap to Beta", href: "/roadmap", order: 1 },
      { title: "Introduction", href: "/getting-started", order: 2 },
      { title: "Installation", href: "/getting-started/installation", order: 3 },
      { title: "Troubleshooting", href: "/troubleshooting", order: 4 },
      { title: "Quick Start", href: "/getting-started/quick-start", order: 5 },
      { title: "Architecture", href: "/architecture", order: 6 },
      { title: "Examples", href: "/examples", order: 7 },
    ],
  },
  {
    title: "Core Concepts",
