...
const sections: SidebarSection[] = [
  {
    ...
    links: [
      ...
      { title: "node! Macro", href: "/node-macro", order: 5 },
    ],
  },
  {
    title: "Core Concepts",
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Using Prebuilt Nodes", href: "/using-prebuilt-nodes", order: 9 },
      { title: "Library Reference", href: "/library-reference", order: 10 },
      { title: "Message Types", href: "/message-types", order: 11 },
      { title: "Examples", href: "/examples", order: 12 },
      { title: "Multi-Language Support", href: "/multi-language", order: 13 },
      { title: "Performance", href: "/performance", order: 14 },
      { title: "Benchmarks", href: "/benchmarks", order: 15 },
      { title: "Python Bindings", href: "/python-bindings", order: 16 },
      { title: "C Bindings", href: "/c-bindings", order: 17 },
      { title: "AI API Integration", href: "/ai-integration", order: 18 },
    ],
  },
  {
    title: "API Reference",
