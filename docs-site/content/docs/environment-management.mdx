...
> **Note**: Environment registry management commands (`env list`, `env info`, `env delete`, `env export`) are planned for future releases. For now, manage published environments through the registry web interface at https://registry.horus.dev

## Next Steps

- **[Package Management](https://docs.horus-registry.dev/docs/package-management)** - Install and manage packages
- **[Authentication](https://docs.horus-registry.dev/docs/authentication)** - Login to registry
- **[Marketplace](https://docs.horus-registry.dev/docs/marketplace)** - Discover packages and environments
- **[Remote Deployment](https://docs.horus-registry.dev/docs/remote-deployment)** - Deploy to remote robots
