...
- **Why HORUS**: Package registry enables code sharing, isolated environments prevent conflicts
...
We're creating the robotics framework we wish existed when we started.

---

**Ready to get started?** Check out the [Installation Guide](https://docs.horus-registry.dev/getting-started/installation) or dive into [Getting Started](https://docs.horus-registry.dev/getting-started).
