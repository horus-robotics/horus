...
**Ready to get started?** Check out the [Installation Guide](/docs/getting-started/installation) or dive into [Getting Started](https://docs.horus-registry.dev/getting-started).
