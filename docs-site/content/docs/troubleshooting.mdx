...
|--------|----------|--------------|
| `./update.sh` | After git pull, dependency changes | Smart incremental update |
...
**Use when:** You've pulled new code or dependencies changed
...
sudo apt install libssl-dev libudev-dev  # Ubuntu/Debian
...
- **[Installation](/installation)** - First-time installation guide
