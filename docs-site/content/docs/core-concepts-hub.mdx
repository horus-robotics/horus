...
The Hub is HORUS's ultra-low latency publish-subscribe (pub/sub) communication system. It enables nodes to exchange messages through shared memory IPC with **366ns-2.8µs latency**.
...
**Sub-Microsecond Latency**: 366ns for small messages (16B), 1.58µs for larger messages (1.5KB)
...
- Learn about the [Scheduler](https://docs.horus-registry.dev/docs/core-concepts-scheduler) for orchestrating nodes
- Understand [Shared Memory](https://docs.horus-registry.dev/docs/core-concepts-shared-memory) internals
- Explore [Message Types](https://docs.horus-registry.dev/docs/message-types) for standard robotics messages
- Read the [API Reference](https://docs.horus-registry.dev/docs/api-hub) for complete Hub documentation
