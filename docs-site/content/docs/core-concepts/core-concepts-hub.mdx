...
See [Communication Transport](/communication-transport) for detailed comparison and [Network Communication](/network-communication) for multi-machine setup.
...
- Learn about the [Scheduler](/core-concepts/core-concepts-scheduler) for orchestrating nodes
- Understand [Shared Memory](/core-concepts/core-concepts-shared-memory) internals
- Explore [Message Types](/core-concepts/message-types) for standard robotics messages
- Read the [API Reference](/api) for complete Hub documentation
