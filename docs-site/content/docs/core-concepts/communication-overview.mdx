...
See [Communication Transport](/communication-transport) for details on local vs network.
...
- [Hub (MPMC) Details](/core-concepts/core-concepts-hub) - Deep dive into Hub
- [Link (SPSC) Details](/core-concepts/core-concepts-link) - Deep dive into Link
- [Communication Transport](/core-concepts/communication-transport) - Local vs Network
- [Network Communication](/core-concepts/network-communication) - Multi-machine systems
