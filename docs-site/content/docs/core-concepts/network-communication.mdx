...
- [Communication Transport](/communication-transport) - Local vs Network overview
- [Communication Configuration](/communication-configuration) - Config files and management
- [Hub (MPMC)](/core-concepts-hub) - Hub pattern deep dive
- [Link (SPSC)](/core-concepts-link) - Link pattern deep dive
