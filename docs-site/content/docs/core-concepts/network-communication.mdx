...
See [Python Bindings - Network Communication](/multi-language/python-bindings#network-communication) for full Python documentation.
...
❌ **Don't use network for 10kHz loops**
```rust
...
- [Communication Transport](/core-concepts/communication-transport) - Local vs Network overview
- [Communication Configuration](/core-concepts/communication-configuration) - Config files and management
- [Hub (MPMC)](/core-concepts/core-concepts-hub) - Hub pattern deep dive
- [Link (SPSC)](/core-concepts/core-concepts-link) - Link pattern deep dive
