...
- **Cross-language**: Rust, Python, C++ all see the same typed data
...
The `LogSummary` trait is **required for all message types** used with Hub/Link communication. It provides a human-readable summary for logging and dashboard monitoring.
...
- Logs written to:
  ...
  - Dashboard logs tab (accessible via `horus dashboard`)
...
Messages with LogSummary appear automatically in the dashboard:
...
- **[Basic Examples](/basic-examples)** - Fundamental patterns including teleop robot, sensor fusion, and custom messages
- **[Advanced Examples](/advanced-examples)** - Complex patterns like state machines and multi-process systems
- **[Second Application](/second-application)** - Step-by-step 3-node pipeline tutorial
...
For complete, runnable examples, see [Basic Examples](/basic-examples) and [Advanced Examples](/advanced-examples).
...
- **[API Reference](/api/api)** - Detailed message type documentation
- **[Performance Optimization](/performance/performance)** - Optimize for large messages
- **[Python Bindings](/multi-language/python-bindings)** and **[C Bindings](/c-bindings)** - Multi-language support
