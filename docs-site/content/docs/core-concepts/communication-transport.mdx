...
See [Communication Configuration](/communication-configuration) for details.
...
- [Local (Shared Memory)](/core-concepts/core-concepts-shared-memory) - Deep dive into shared memory
- [Network Communication](/core-concepts/network-communication) - Multi-machine systems guide
- [Communication Configuration](/core-concepts/communication-configuration) - Config files and endpoints
- [Hub (MPMC)](/core-concepts/core-concepts-hub) - Hub pattern details
- [Link (SPSC)](/core-concepts/core-concepts-link) - Link pattern details
