...
- [Local (Shared Memory)](/core-concepts-shared-memory) - Deep dive into shared memory
- [Network Communication](/network-communication) - Multi-machine systems guide
- [Communication Configuration](/communication-configuration) - Config files and endpoints
- [Hub (MPMC)](/core-concepts-hub) - Hub pattern details
- [Link (SPSC)](/core-concepts-link) - Link pattern details
