...
```
Use for: Monitoring dashboards, logging aggregators, fleet management
...
- Learn about [Message Types](/core-concepts/message-types) for standard robotics data
- Read the [Performance Guide](/performance/performance) for optimization tips
- Explore [Examples](/basic-examples) showing shared memory usage
