...
**Performance**: 481ns for small messages (16B), scales linearly with size
...
fn tick(&mut self, ctx: Option<&mut NodeInfo>) {
    ...
    // Automatically logs: [12:34:56.789] [IPC: 481ns] MyNode --PUB--> 'topic' = 42.0
}
```
...
**Performance**: 481ns for small messages (16B)
