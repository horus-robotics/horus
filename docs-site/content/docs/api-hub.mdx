...
**Returns**: `Result<Hub<T>, Box<dyn std::error::Error>>`
...
- [Node API Reference](https://docs.horus-registry.dev/docs/api-node) - Node implementation
- [Scheduler API Reference](https://docs.horus-registry.dev/docs/api-scheduler) - Node orchestration
- [Core Concepts: Hub](https://docs.horus-registry.dev/docs/core-concepts-hub) - Detailed guide
- [Message Types](https://docs.horus-registry.dev/docs/message-types) - Standard messages
