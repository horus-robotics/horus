...
|--------------|------|-------------|--------------|----------|---------|
| CmdVel | 16B | ~437ns | 248ns | 50-100µs | **100-320x** |
| IMU | 304B | ~940ns | ~400ns | 80-150µs | **85-375x** |
| LaserScan | 1.5KB | ~2.2µs | ~900ns | 150-300µs | **68-333x** |
...
|-----------|---------|------------|--------------|
| Shared Memory | ~250ns | 10M+ msg/s | Local only |
