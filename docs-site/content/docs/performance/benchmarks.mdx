...
|-----------|-----------|------------|-----------|
| **HORUS Link (SPSC)** | **248 ns** | **~400 ns** | **~900 ns** |
| **HORUS Hub (MPMC)** | **481 ns** | **~620 ns** | **~1.4 μs** |
| ROS2 (DDS) | 50-100 μs | 100-500 μs | 1-10 ms |
| ROS2 (FastDDS) | 20-50 μs | 50-200 μs | 500 μs - 5 ms |

**Performance Advantage**: HORUS is **80-403x faster** than ROS2 for typical message sizes.
...
|-------------|--------------|-------------|--------------|---------|
| 16 B | CmdVel | ~500 ns | 248 ns | **160-403x faster** |
