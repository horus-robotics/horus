...
**Performance**: 366ns-2.8μs depending on message size
...
- [Examples](https://docs.horus-registry.dev/docs/examples) - More code examples
- [Performance](https://docs.horus-registry.dev/docs/performance) - Optimization guide
- [Message Types](https://docs.horus-registry.dev/docs/message-types) - Standard message definitions
