...
|-----------|--------|------------|----------|-------------|
| **sim2d** | ⚠️ **Active Development** | 2D Top-Down | Fast prototyping, navigation | 1000+ Hz headless |
...
> ⚠️ **Status:** Active Development - Core features working, polish ongoing
...
- ⚠️ Limited to 2D top-down view
- ⚠️ No camera/vision sensors yet
- ⚠️ Basic visualization (no shadows, advanced graphics)
- ⚠️ Documentation being updated
...
│ horus sim    │ Debug panels │ RL training           │
└──────┬───────┴──────┬───────┴──────┬────────────────┘
       │              │              │
┌──────▼──────────────▼──────────────▼────────────────┐
...
- 🚧 Bevy + Rapier3D integration
- 🚧 Basic robot spawning
- 🚧 Camera controls

**Phase 2: Robot Support** (Q2 2026)
- 🚧 URDF loading
- 🚧 TF system implementation
- 🚧 Articulated robots
- 🚧 Joint controllers
...
| **RL Ready** | ⚠️ Basic | ✅ Yes | ⚠️ Plugins | ⚠️ Plugins | ✅ Yes |
...
- 🚧 Multi-robot support (in progress)
- 🚧 Additional sensors (camera, IMU)
- 📋 Scene editor
- 📋 Scenario library
