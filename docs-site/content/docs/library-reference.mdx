...
> **Under Development**: The HORUS Standard Library is currently under active development. Some nodes and features described may be incomplete or subject to change.
...
- **Example Applications** (Unies) - Complete multi-node demonstrations
...
**Run:**
```bash
cd horus_library/unies/tanksim
cargo run --release
```
...
- **[Message Types Guide](https://docs.horus-registry.dev/docs/message-types)** - Detailed message documentation
- **[node! Macro](https://docs.horus-registry.dev/docs/node-macro)** - Create custom nodes easily
- **[Examples](https://docs.horus-registry.dev/docs/examples)** - Complete applications
- **[API Reference](https://docs.horus-registry.dev/docs/api)** - Full API documentation
