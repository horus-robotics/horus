...
> **Note**: `.horus/` is automatically managed. HORUS uses smart dependency resolution with local-first priority and global cache fallback. See [Environment Management](/environment-management#solving-dependency-hell) for details.
...
**Core Concepts:**
- **[Nodes](/core-concepts-nodes)** - Deep dive into the Node pattern
- **[Hub](/core-concepts-hub)** - How ultra-fast communication works
- **[Scheduler](/core-concepts-scheduler)** - Priority-based execution

**Make Development Easier:**
- **[node! Macro](/node-macro)** - Eliminate boilerplate code
- **[CLI Reference](/cli-reference)** - All the `horus` commands
- **[Dashboard](/dashboard)** - Monitor your application visually

**See More Examples:**
- **[Examples](/examples)** - Real applications you can run
- **[Multi-Language](/multi-language)** - Use Python or C instead
...
1. **[Use the node! macro](/node-macro)** to eliminate boilerplate
2. **[Run the examples](/examples)** to see real applications
3. **[Open the dashboard](/dashboard)** to monitor your system

**Having issues?** See the **[Troubleshooting Guide](/troubleshooting)** for help with common problems.
