...
|----------|--------|-------------------|-------|
| **Ubuntu 20.04+** | ✅ Native | `/dev/shm/horus/` | Recommended for production |
| **Ubuntu 22.04+** | ✅ Native | `/dev/shm/horus/` | Best performance |
| **Debian 11+** | ✅ Native | `/dev/shm/horus/` | Tested and working |
| **Fedora 36+** | ✅ Native | `/dev/shm/horus/` | Use dnf for packages |
| **Arch Linux** | ✅ Native | `/dev/shm/horus/` | Community maintained |
| **Raspberry Pi** | ✅ Native | `/dev/shm/horus/` | ARM64 tested on Ubuntu |
| **macOS** | ✅ Native | `/tmp/horus/` | tmpfs-backed, full support |
| **Windows** | ✅ Native | `%TEMP%\horus\` | Native Windows support |
| **WSL 2** | ✅ Native | `/dev/shm/horus/` | Linux mode in WSL |
