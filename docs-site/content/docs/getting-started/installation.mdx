...
See [Multi-Language](https://docs.horus-registry.dev/docs/multi-language) for Python examples.
...
See [Multi-Language](https://docs.horus-registry.dev/docs/multi-language) for C examples.
...
1. **[Quick Start Tutorial →](https://docs.horus-registry.dev/getting-started/quick-start)**
   Build your first HORUS application in 10 minutes

2. **[CLI Reference →](https://docs.horus-registry.dev/docs/cli-reference)**
   Learn all the `horus` commands

3. **[Examples →](https://docs.horus-registry.dev/docs/examples)**
   See real HORUS applications

**Ready to start?** Head to the [Quick Start →](https://docs.horus-registry.dev/getting-started/quick-start)
