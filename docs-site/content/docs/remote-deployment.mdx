...
> **Under Development**: The remote deployment features described in this guide are currently under active development. Some functionality may be incomplete or subject to change.
...
[12:34:56.792] [IPC: 366ns] VelocityController --PUB--> 'cmd_vel' = 1.5
...
- **[Dashboard Guide](https://docs.horus-registry.dev/docs/dashboard)** - Monitor remote robots
- **[CLI Reference](https://docs.horus-registry.dev/docs/cli-reference)** - Command-line tools for deployment
- **[Environment Management](https://docs.horus-registry.dev/docs/environment-management)** - Deploy consistent environments
- **[Package Management](https://docs.horus-registry.dev/docs/package-management)** - Manage dependencies on remote robots
- **[Authentication](https://docs.horus-registry.dev/docs/authentication)** - Secure registry access
