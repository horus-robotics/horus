...
See [Dashboard Guide](https://docs.horus-registry.dev/docs/dashboard) for detailed features.
...
1. **[Quick Start](https://docs.horus-registry.dev/getting-started/quick-start)** - Build your first app
2. **[node! Macro](https://docs.horus-registry.dev/docs/node-macro)** - Write less code
3. **[Dashboard Guide](https://docs.horus-registry.dev/docs/dashboard)** - Master monitoring
4. **[Examples](https://docs.horus-registry.dev/docs/examples)** - See real applications

**Questions?** Check the [Getting Started](https://docs.horus-registry.dev/docs/getting-started) guide or [Core Concepts](https://docs.horus-registry.dev/docs/core-concepts-nodes).
