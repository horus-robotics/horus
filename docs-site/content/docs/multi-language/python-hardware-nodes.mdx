...
|------|----------|---------|------------|
| [`SerialNode`](#serialnode) | UART/RS232 | pyserial | ✅ |
| [`JoystickNode`](#joysticknode) | Gamepads | pygame | ✅ |
| [`KeyboardNode`](#keyboardnode) | Keyboard | pynput | ✅ |
| [`ImuNode`](#imunode) | MPU6050 IMU | smbus2 | ✅ |
| [`GpsNode`](#gpsnode) | NMEA GPS | pynmea2 | ✅ |
| [`CameraNode`](#cameranode) | USB/CSI cameras | opencv-python | ✅ |
| [`LidarNode`](#lidarnode) | RPLidar | rplidar-roboticia | ✅ |
...
- [Python Bindings](/multi-language/python-bindings) - Core Python API
- [Node Simulation Mode](/development/simulation#node-simulation-mode) - Simulation details
- [Built-in Nodes](/built-in-nodes) - Rust node reference
