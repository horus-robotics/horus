...
Make sure you have [installed HORUS](/installation) before continuing.
...
- Learn about [Core Concepts](/core-concepts-nodes) to understand the architecture
...
- Optimize performance with the [Performance Guide](/performance)
