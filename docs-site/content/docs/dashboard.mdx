...
> **⚠️ Under Development**: The HORUS Dashboard is currently under active development. Core monitoring features work, but some functionality (parameter management UI, package browser) is still being finalized. Check back for updates as we complete this feature.
