...
- **[Installation Guide](https://docs.horus-registry.dev/getting-started/installation)**: Set up HORUS on your system
- **[Quick Start](https://docs.horus-registry.dev/getting-started/quick-start)**: Build your first node in 5 minutes
- **[Goals & Vision](https://docs.horus-registry.dev/docs/goals)**: Understand what HORUS is trying to achieve
- **[API Reference](https://docs.horus-registry.dev/docs/api)**: Detailed API documentation
- **[Examples](https://docs.horus-registry.dev/docs/examples)**: Complete example applications
