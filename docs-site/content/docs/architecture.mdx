...
- **[Installation Guide](/docs/getting-started/installation)**: Set up HORUS on your system
- **[Quick Start](/docs/getting-started/quick-start)**: Build your first node in 5 minutes
