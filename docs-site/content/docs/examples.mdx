...
mod tests {
    ...
    fn test_sensor_node() {
        ...
        let mut ctx = NodeInfo::new("TestSensor");
    ...
    fn test_pubsub_integration() -> Result<(), Box<dyn std::error::Error>> {
        ...
        // Note: Scheduler::tick_all() runs infinitely
        // For testing, you'd implement a Scheduler::tick_once() method
        // or use integration tests with timeouts
...
- Optimize with the [Performance Guide](https://docs.horus-registry.dev/docs/performance)
- Learn about [Python Bindings](https://docs.horus-registry.dev/docs/python-bindings) and [C Bindings](https://docs.horus-registry.dev/docs/c-bindings)
- Explore the [Core Concepts](https://docs.horus-registry.dev/docs/core-concepts-nodes) for deeper understanding
