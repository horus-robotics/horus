...
- **Built-in Nodes** - Production-ready nodes for sensors, actuators, and control (see [Built-in Nodes/Drivers](/built-in-nodes))
...
**[Built-in Nodes/Drivers Reference →](/built-in-nodes)**
...
- **[Built-in Nodes/Drivers](/built-in-nodes)** - Complete node documentation
- **[Message Types Guide](/core-concepts/message-types)** - Detailed message documentation
- **[node! Macro](/core-concepts/node-macro)** - Create custom nodes easily
- **[Examples](/basic-examples)** - Complete applications
