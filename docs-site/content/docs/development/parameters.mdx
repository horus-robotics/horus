...
- **[Dashboard Guide](/development/dashboard)** - Manage parameters via web interface
- **[node! Macro Guide](/core-concepts/node-macro)** - Learn about `init()` and `tick()` hooks
- **[Examples](/basic-examples)** - See real-world parameter usage
