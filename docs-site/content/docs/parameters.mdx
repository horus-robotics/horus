...
See [Dashboard Guide](https://docs.horus-registry.dev/docs/dashboard#parameter-management) for API details.
...
- **[Dashboard Guide](https://docs.horus-registry.dev/docs/dashboard)** - Manage parameters via web interface
- **[node! Macro Guide](https://docs.horus-registry.dev/docs/node-macro)** - Learn about `init()` and `tick()` hooks
- **[Examples](https://docs.horus-registry.dev/docs/examples)** - See real-world parameter usage
- **[CLI Reference](https://docs.horus-registry.dev/docs/cli-reference)** - Command-line parameter tools
