...
- [node! Macro Guide](/docs/core-concepts/node-macro) - Detailed tutorial
- [message! Macro Guide](/docs/core-concepts/message-macro) - Custom messages
- [horus_core API](/docs/api/core) - Core types reference
