...
- **Performance**: 100-270x faster than ROS2
...
| Message Type | Size | Latency | Throughput | vs ROS2 |
|--------------|------|---------|------------|---------|
...
See [Benchmarks](/docs/benchmarks) for complete performance analysis.
...
- [Benchmarks](/docs/benchmarks) - Production performance analysis
- [Examples](/docs/examples) - Real-world robotics applications
