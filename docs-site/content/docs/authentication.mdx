...
> **Note**: API key usage monitoring and alerts are managed through the registry web interface at http://localhost:3001 (local) or https://marketplace.horus-registry.dev (public)
...
# Visit http://localhost:3001 or https://marketplace.horus-registry.dev
