...
> **Note**: Managing API keys (listing, revoking, etc.) is currently done through the registry web interface at https://registry.horus.dev
...
# Visit https://registry.horus.dev to manage keys
```

### Monitoring

> **Note**: API key usage monitoring and alerts are managed through the registry web interface at https://registry.horus.dev
...
- **[Marketplace](https://docs.horus-registry.dev/docs/marketplace)** - Publish and discover packages
...
- **[Registry & Marketplace](https://docs.horus-registry.dev/docs/registry-marketplace)** - Explore the registry
