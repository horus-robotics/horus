...
if ! command -v cc &> /dev/null && ! command -v gcc &> /dev/null; then
    ...
    echo "  sudo apt update && sudo apt install build-essential pkg-config libudev-dev libssl-dev"
    echo ""
    echo -e "${CYAN}Fedora/RHEL/CentOS:${NC}"
    echo "  sudo dnf groupinstall \"Development Tools\""
    echo "  sudo dnf install pkg-config systemd-devel openssl-devel"
    echo ""
...
if ! command -v pkg-config &> /dev/null; then
    ...
    echo ""
    echo -e "${CYAN}Ubuntu/Debian:${NC}"
    echo "  sudo apt install pkg-config libudev-dev libssl-dev"
    echo ""
    echo -e "${CYAN}Fedora/RHEL/CentOS:${NC}"
    echo "  sudo dnf install pkg-config systemd-devel openssl-devel"
    echo ""
