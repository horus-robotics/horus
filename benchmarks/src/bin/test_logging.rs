...
fn test_performance() -> bool {
    ...
    let receiver = match Link::<CmdVel>::consumer(&topic_baseline) {
        Ok(r) => r,
        Err(e) => {
...
fn test_context() -> bool {
    ...
    let sub1 = match Hub::<CmdVel>::new(&topic1) {
        Ok(s) => s,
        Err(e) => {
    ...
    let pub2 = match Hub::<CmdVel>::new(&topic2) {
        Ok(p) => p,
        Err(e) => {
    ...
    let sub2 = match Hub::<CmdVel>::new(&topic2) {
        Ok(s) => s,
        Err(e) => {
