...
use crate::{Twist, DifferentialDriveCommand, Odometry};
...
impl DifferentialDriveNode {
    ...
    fn clamp_twist(&self, mut twist: Twist) -> Twist {
        ...
        twist.linear[0] = twist.linear[0].clamp(-self.max_linear_vel as f64, self.max_linear_vel as f64);
        ...
        twist.angular[0] = 0.0;
        twist.angular[1] = 0.0;
        twist.angular[2] = twist.angular[2].clamp(-self.max_angular_vel as f64, self.max_angular_vel as f64);
