...
def test_message_age():
    ...
    scheduler = horus.Scheduler()
    scheduler.register(pub_node, priority=0, logging=False, rate_hz=5.0)
    scheduler.register(sub_node, priority=1, logging=False, rate_hz=10.0)
...
def test_staleness_detection():
    ...
    scheduler = horus.Scheduler()
    scheduler.register(pub_node, priority=0, logging=False, rate_hz=10.0)
    scheduler.register(check_node, priority=1, logging=False, rate_hz=10.0)
...
def test_get_timestamp():
    ...
    scheduler = horus.Scheduler()
    scheduler.register(pub_node, priority=0, logging=False, rate_hz=10.0)
    scheduler.register(read_node, priority=1, logging=False, rate_hz=10.0)
